...
class GraniteTranscriber:
    ...
    def __init__(
        ...
        Args:
            model_name: HuggingFace model name (default: ibm-granite/granite-speech-3.3-2b)
    ...
    def _load_audio(self, audio_path: str) -> torch.Tensor:
        ...
        # Use librosa directly (torchaudio 2.9 has torchcodec dependency issues)
        import librosa
    ...
    def transcribe(self, audio_path: str, max_new_tokens: int = 4096) -> str:
        ...
        try:
            ...
            # Create chat-style prompt for transcription (Granite-specific format)
            system_prompt = "You are Granite, developed by IBM. You are a helpful AI assistant."
