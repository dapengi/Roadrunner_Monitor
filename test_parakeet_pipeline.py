#!/usr/bin/env python3
"""
Test script for Parakeet TDT 0.6b-v2 integrated pipeline
Tests the full workflow: download -> extract -> transcribe -> format -> upload
"""
import sys
import datetime
import json
...
print('=' * 70)
print('TESTING PARAKEET TDT 0.6b-v2 PIPELINE')
print('=' * 70)
...
print('\n4. Transcribing with Parakeet TDT 0.6b-v2 + SpeechBrain Diarization...')
