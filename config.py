...
WHISPERX_DEVICE = "cpu"  # WhisperX doesn't support MPS yet
...
def validate_config():
    ...
    if not HF_TOKEN:
        errors.append("Hugging Face token missing (HF_TOKEN) - required for speaker diarization")
...
def get_config_summary():
    ...
    return {
        ...
        'using_gpu': torch.cuda.is_available() if torch.cuda else False
    }
