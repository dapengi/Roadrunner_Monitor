#!/usr/bin/env python3
"""Reprocess single meeting with fixes"""
...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("reprocess_single.log"), logging.StreamHandler()]
)
...
if __name__ == "__main__":
    # Reprocess the 1:34 PM - 5:35 PM HAFC meeting from Jan 12, 2026
    video_url = "https://sg001-harmony.sliq.net/00293/Harmony/en/PowerBrowser/PowerBrowserV2/20250522/-1/77963"
    title = "House - Appropriations and Finance (Room 307) 1:34 PM-5:35 PM Mon, Jan 12, 2026"
    meeting_date = datetime.datetime(2026, 1, 12, 13, 34)  # Jan 12, 2026 at 1:34 PM
