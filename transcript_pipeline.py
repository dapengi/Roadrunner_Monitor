...
Diarization: SpeechBrain ECAPA-TDNN (6.7x faster than Pyannote)
"""
...
class TranscriptPipeline:
    ...
    Uses Granite Speech with Whisper fallback and SpeechBrain diarization.
    """
    ...
    def _diarize_audio(self, audio_path: str) -> List[Dict]:
        ...
        """
        from modules.speechbrain_diarization import SpeechBrainDiarizer

        diarizer = SpeechBrainDiarizer(device="cpu")
    ...
    def process_meeting(
        ...
        try:
            ...
            # Step 2: Speaker diarization with SpeechBrain
            logger.info("Step 2/4: Speaker diarization with SpeechBrain...")
            try:
